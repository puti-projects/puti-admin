export default {
  ...
  option: {
    ...
    siteEnableTheme: '启用',
    siteSettingOutput: '输出配置（搭配主题使用，因为不同主题可能需要不同的展示内容）',
    siteShowOnIndex: '首页显示',
    siteShowNewArticles: '您的最新文章',
    siteShowPage: '一个静态页面',
    siteChoose: '选择',
    siteShowOnIndexDesc: '首页要显示的内容。',
    siteShowLimit: '，最多显示',
    siteShowArticles: '篇文章',
    siteOutofLimit: '（超出时将放到下一页）',
    siteShowknowledge: '知识库',
    contentSetting: '内容配置',
    contentSettingWritting: '撰写',
  ...
  knowledge: {
    note: '笔记',
    notebook: '笔记本',
    noteDesc: '笔记本可以随心所欲地记录并归类',
    doc: '文档',
    documentSet: '文档集',
    docDesc: '文档集可以很好地将文档进行集合成册。',
    newNote: '新建笔记本',
    newDoc: '新建文档集',
    createNow: '立即创建',
    createNote: '创建笔记本',
    ...
    knowledgeDescriptionDesc: '知识库的相关描述',
    knowledgeCoverImage: '封面图',
    knowledgeCoverImageDesc: '上传一张封面图',
    cancelImage: '已取消选择的图片',
    uploadAgainTips: '您可以重新选择一张',
    uploadCoverSuccess: '封面上传成功',
    creatingKnowledgeNow: '正在创建知识库......',
    pleaseInputName: '请输入知识库名称',
    pleaseCheckNameLength: '请检查知识库名称长度',
    pleaseCheckSlugLength: '请检查知识库别名长度',
    pleaseCheckDescriptionLength: '描述内容太长',
    startWrite: '开始写作',
